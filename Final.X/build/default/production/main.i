...
volatile unsigned char alarme_leve = 0;
...
float calculaTemperaturaSimples(unsigned int adc_valor) {
    ...
    float temp = ((float)adc_valor / 950.0) * 27.0;
    return temp;
}
...
void main(void) {
    ...
    while(1){
         if(alarme_leve){
            ...
            _delay((unsigned long)((110000)*(20000000/4000000.0)));
          ...
          if(alarme_ativo){
             ...
             LATDbits.LATD0 = !PORTDbits.RD0;
             LATCbits.LATC2 = !PORTCbits.RC2;
             _delay((unsigned long)((60000)*(20000000/4000000.0)));
        ...
        Posiciona_LCD(1,1);
        sprintf(lcd_buffer, "ADC: %04d", adc_gas);
